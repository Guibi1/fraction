...
QT_MOC_LITERAL(1, 12, 11), // "setFraction"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 8), // "Fraction"
QT_MOC_LITERAL(4, 34, 8) // "fraction"

    },
    "FractionGui\0setFraction\0\0Fraction\0"
    "fraction"
};
...
void FractionGui::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        FractionGui *_t = static_cast<FractionGui *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setFraction((*reinterpret_cast< const Fraction(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
QT_INIT_METAOBJECT const QMetaObject FractionGui::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_FractionGui.data,
      qt_meta_data_FractionGui,  qt_static_metacall, nullptr, nullptr}
};
