...
INCPATH       = -I. -I../Guibi -I../../../Qt/5.10.1/gcc_64/include -I../../../Qt/5.10.1/gcc_64/include/QtWidgets -I../../../Qt/5.10.1/gcc_64/include/QtGui -I../../../Qt/5.10.1/gcc_64/include/QtCore -I. -isystem /usr/include/libdrm -I../../../Qt/5.10.1/gcc_64/mkspecs/linux-g++
...
SOURCES       = fraction.cpp \
		main.cpp \
		stylefraction.cpp \
		fenfraction.cpp moc_stylefraction.cpp
OBJECTS       = fraction.o \
		main.o \
		stylefraction.o \
		fenfraction.o \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents fraction.h stylefraction.h fenfraction.h $(DISTDIR)/
	$(COPY_FILE) --parents fraction.cpp main.cpp stylefraction.cpp fenfraction.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_stylefraction.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_stylefraction.cpp
